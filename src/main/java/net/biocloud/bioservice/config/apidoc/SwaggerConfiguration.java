package net.biocloud.bioservice.config.apidoc;
...
public class SwaggerConfiguration {
    ...
    public Docket swaggerSpringfoxDocket(BioserviceProperties bioserviceProperties) {
        ...
        ApiInfo apiInfo = new ApiInfo(
                bioserviceProperties.getSwagger().getTitle(),
                bioserviceProperties.getSwagger().getDescription(),
                bioserviceProperties.getSwagger().getVersion(),
                bioserviceProperties.getSwagger().getTermsOfServiceUrl(),
                bioserviceProperties.getSwagger().getContact(),
                bioserviceProperties.getSwagger().getLicense(),
